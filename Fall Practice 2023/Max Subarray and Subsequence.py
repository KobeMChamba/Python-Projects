...
def maxSubarray(arr):
    ...
    max_non_cont_sum = arr[0]  # Initialize the maximum non-continuous sum
    ...
    for i in range(1, len(arr)):
        ...
        max_non_cont_sum = max(max_non_cont_sum, max_non_cont_sum + arr[i])

    # Return the maximum subarray and subsequence
    return max_sum, max_non_cont_sum
